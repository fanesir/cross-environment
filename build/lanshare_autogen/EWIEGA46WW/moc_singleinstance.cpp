...
QT_MOC_LITERAL(1, 15, 18), // "newInstanceCreated"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 15) // "onNewConnection"

    },
    "SingleInstance\0newInstanceCreated\0\0"
    "onNewConnection"
};
...
void SingleInstance::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newInstanceCreated(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SingleInstance::newInstanceCreated)) {
                *result = 0;
                return;
            }
        }
